...
export const booksData: Book[] = [
  {
    ...
    description:
      "A direct challenge to the myth of solo success and the unseen forces behind achievement.",
  ...
  },
  {
    ...
    description:
      "Exploring perspectives from both sides of life's challenges and opportunities.",
    slug: "both-sides",
  },
  {
    id: 4,
    ...
    description:
      "A practical guide to career development and professional success.",
    slug: "get-a-job",
  },
  {
    id: 5,
    ...
    description:
      "A comprehensive exploration of freedom, rights, and personal liberty.",
    slug: "liberty",
  },
  {
    id: 6,
    ...
    description:
      "Uncovering hidden truths and perspectives you never saw coming.",
    slug: "never-saw-it",
  },
  {
    id: 7,
    ...
    description:
      "Harnessing the power of overwhelming force for breakthrough results.",
  ...
  },
  {
    ...
    description:
      "A personal reflection on faith, family, and the lasting influence of a father's example.",
  ...
  },
  {
    ...
    description:
      "Lessons drawn from mistakes, setbacks, and the decisions that shaped a bigger vision.",
    slug: "mistakes-that-made-me-a-trillionaire",
  },
  {
    id: 10,
    title: "The Inefficiencies of Correction and How to Fix It",
    image: "/books/the-inefficiencies-of-correction-and-how-to-fix-it.png",
    description:
      "Tackling the inefficiencies in correctional systems and proposing actionable solutions.",
    slug: "the-inefficiencies-of-correction-and-how-to-fix-it",
  },
];
